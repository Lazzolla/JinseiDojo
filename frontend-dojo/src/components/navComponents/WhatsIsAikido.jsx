...
export default function WhatsIsAikido(props) {
    ...
    return (
        ...
        >
            <Card className="whatIsAikido-card bg-transparent">
                <Card.Body>
                    <FontAwesomeIcon
                    ...
                    />
                    <Card.Title className="whatIsAikido-card-title text-center">
                        ¿Qué es el Aikido?
                    </Card.Title>
                    <Card.Text className="whatIsAikido-firstText">
                    ...
                    <div className="whatIsAikido-img-first-div">
                        <Image
                    ...
                    <Card.Text className="whatIsAikido-secondText">
                    ...
                    <div className="whatIsAikido-img-second-div">
                        <Image
                    ...
                    <Card.Text className="whatIsAikido-thirdText">
                    ...
                    <div className="whatIsAikido-img-third-div">
                        <Image
                    ...
                    <Card.Text className="whatIsAikido-fourthText">
