...
export default function Blog() {
  ...
  useEffect(() => {
    socket.on('latestPubUpdated', () => getPublications())
  ...
  return (
    <Fragment>
      <div className="bg-blog">
        <div className="blog-card-filters">
          <div className="blog-form-search-author">
            <h3 className="blog-form-h3-author">
              Autor
            </h3>
            <Form.Control
              name="author"
          ...
          <div className="blog-form-search-title">
            <h3 className="blog-form-h3-title">
              Titulo
            </h3>
            <Form.Control
              name="title"
          ...
          <div className="blog-filters-timeFilter">
            <p className={recents}>
              Mas antiguas
            </p>
            <div className="blog-filters-icon">
              <FontAwesomeIcon
                type="button"
                icon={faSort}
        ...
        <div className="blog-card">
          <h1 className="blog-title-gral">
            Todas las publicaciones
          </h1>
          {displayError.length > 0
            ? <h4 className="blog-subtitle-gral text-danger">
              {displayError}
            </h4>
            : <h4
              type="button"
