...
export default class PrintProgram extends Component {
    ...
    render() {
        ...
        { this.props.program
        ? <Card
         className="printProgram-card-exam"
         >
                <Card.Body 
                className="printProgram-card-body"
                >
                  <Card.Title 
                  ...
                  <Card.Subtitle
                   className="printProgram-subTitle mb-2 text-center mb-3 text-muted"
                  ...
                  >
                    <thead 
                    className="printProgram-tableFontSizes"
                    >
                      <tr>
                        <th>
                          Ataque
